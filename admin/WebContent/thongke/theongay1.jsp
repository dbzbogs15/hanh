        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <%  Map<String, Order> mapDH = new ThongKeDAO().thongKeTheoNgayHeThong();
                    ...
                    if (ok != null) {
                        if (ok.equals("ok")) {
                            ...
                            mapDH = new ThongKeDAO().thongKeTheoNgayHeThong();
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <%int count = 0;
                        int tongSoLuong=0; int tongTien=0;
            ...
            <div class="row">
                ...
                <div class="col-sm-6 well" >
                    ...
                    <p>Tổng số lượng sản phẩm bán được trong ngày <%=ngay%> là: <%=tongSoLuong%></p>    
                          <p>Tổng tiền thu được trong ngày <%=ngay%> là: <%=tongTien%></p>    
