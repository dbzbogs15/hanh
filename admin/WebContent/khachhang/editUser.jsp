            ...
            <div class="jumbotron">
                <div class="row">
                    ...
                    <div class="phom">
                        ...
                        <jsp:forward page="../quanlykhachhang.jsp"></jsp:forward> <%}%>
                        <%User user = (User) context.getAttribute("user");%>
                        <form action="<%=request.getContextPath()%>/UserController" class="form-horizontal" role="form" style="color: black" method="GET">
                            <input type="hidden" name="hidAction" value="UpdateUser">
                            <input type="hidden" name="key" value="<%out.print(user.getUsername());%>">
                            Tài khoản<input name="username" type="text"
                                            class="form-control" value="<%out.print(user.getUsername());%>">
                            <%
                            ...
                            Mật khẩu<input name="password" type="text"
                                           class="form-control" value="<%out.print(user.getPassword());%>">
                            <%
                            ...
                            Email<input name="email" type="text"
                                        class="form-control" value="<%out.print(user.getEmail());%>">
                            <%
                            ...
                            Số điện thoại<input name="phone" type="text"
                                                class="form-control" value="<%out.print(user.getPhone());%>">
                            <%
                            ...
                            Họ khách hàng<input name="fname" type="text"
                                                class="form-control" value="<%out.print(user.getFname());%>">
                            <%
                            ...
                            Giới tính<select name="gioitinh" class="form-control">
                                ...
                                <%for (String x : gt) {%>
                                <option
                                    <%if (user.getGioitinh().equalsIgnoreCase(x)) {%>
                                    selected <%}%>
                                    value="<%out.print(x);%>"><%out.print(x);%></option>
                                <%}%>
                            </select>
                            <br>
