                        ...
                        <div class="text-center">
                          ...
                          <p>You can reset your password here.</p>
                            <div class="panel-body">
                              ...
                              <form  action="<%=request.getContextPath()%>/XuLiQuenMatKhau" method="post">
                                <fieldset>
                                <%
                                ServletContext contextEmail= getServletContext();
                                String mess="";
                                 mess=(String)contextEmail.getAttribute("message");
                                if(mess!=null){
                                %>
                                <center color="red"> <%=mess %></center><%} %>
                                  ...
                                  <a href="login.jsp">>>>Go to see Login</a>
                                </fieldset>
                              </form>
